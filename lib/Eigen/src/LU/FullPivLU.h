...
void FullPivLU<MatrixType, PermutationIndex>::computeInPlace() {
  ...
  // the src loop is over, we still have to accumulate the transpositions to find the
...
struct kernel_retval<FullPivLU<MatrixType_, PermutationIndex_> >
  ...
  void evalTo(Dest& dst) const {
    ...
    // the src diagonal. We need that to be able to apply our triangular solvers.
